...
export default [
  ...
  ...prefix('transformer-substations', [
    route(':id', './routes/transformer-substations/transSubId/transformerSubstation.tsx'),
    route(':id/add-data', './routes/transformer-substations/add-data/addData.tsx'),
    route(':id/change-data', './routes/transformer-substations/change-data/changeData.tsx'),
