 ...
 *
 * @example
 * const futureRecordIds = await getUnregisteredMeterRecordIdsAfterDate(executor, {
 *   balanceGroup: "ЮР Sims",
 ...
 *
 * @example
 * const updatedCount = await incrementUnregisteredMetersRecords(executor, [12, 22, 44], 3)
 */
